...
[![Github Actions Status](https://github.com/dlqqq/jupyter-ai-braket/workflows/Build/badge.svg)](https://github.com/dlqqq/jupyter-ai-braket/actions/workflows/build.yml)

A Jupyter AI persona designed to assist AWS Braket users on quantum computing tasks.

This extension is composed of a Python package named `jupyter_ai_braket`
for the server extension and a NPM package named `@jupyter-ai-contrib/braket`
...
```bash
pip uninstall jupyter_ai_braket
```
...
# Change directory to the jupyter_ai_braket directory
...
jupyter server extension disable jupyter_ai_braket
pip uninstall jupyter_ai_braket
```

In development mode, you will also need to remove the symlink created by `jupyter labextension develop`
command. To find its location, you can run `jupyter labextension list` to figure out where the `labextensions`
folder is located. Then you can remove the symlink named `@jupyter-ai-contrib/braket` within that folder.
...
```sh
pytest -vv -r ap --cov jupyter_ai_braket
```
